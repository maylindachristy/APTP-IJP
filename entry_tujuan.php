	...
	<div class="content">
		...
		<form action="inserttujuan.php" method="POST">
			<div class="input-group">
				<input type="text" id="notujuan" placeholder="Nomor Indentitas Tujuan" name="no_tujuan">
			</div>
			<div class="input-group">
				<input type="text" id="kotatujuan" placeholder="Kota Tujuan" name="kota_tujuan">
			</div>
			<div class="input-group">
						<select name="no_tiket" id="notiket" style="width: 250px;">
			...
			<div class="input-group">
				<button type="submit" id="btnsubmit" class="btn">Kirim</button>
